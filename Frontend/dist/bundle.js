	        ...
	        switch (menu) {
	            case K.PRINTER_MENU:
	                ...
	                return (React.createElement("div", null,
	                    C.PrinterMenu(items),
	                    React.createElement(C.PrinterInfo, __assign({}, item))));
	            case K.IMAGE_MENU:
	                items = state.modelsBySubmodel[K.IMAGE_SUBMODEL].items;
	                //bad
	                return React.createElement("div", null, C.ImageMenu(items));
	            case K.MAIN_MENU:
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.MainMenu = () => React.createElement("div", null,
	    ...
	    React.createElement("button", { onClick: () => reducers_1.store.dispatch({ type: K.SELECT_MENU, menu: K.IMAGE_MENU }) }, "Image menu"),
	    React.createElement("button", { onClick: () => reducers_1.store.dispatch({ type: K.SELECT_MENU, menu: K.SCAN_MENU }) }, "Scan menu"));
	exports.ImageMenu = (items) => React.createElement("div", null,
	    React.createElement("h2", null,
	...
	exports.PrinterMenu = (items) => React.createElement("div", null,
	    React.createElement("h2", null,
	    ...
	    React.createElement("select", { onChange: e => reducers_1.store.dispatch({
	        ...
	        }) }, items.map(m => React.createElement("option", null, m.item.Name))),
	    React.createElement("br", null),
	    React.createElement(exports.ToMainMenuButton, null),
	    React.createElement("button", { onClick: () => reducers_1.store.dispatch(T.getModelsWS("Is printer there", K.URL_PRINTER_INFO)) }, "Update printers from local app"),
	    React.createElement("br", null));
...
/***/ function(module, exports, __webpack_require__) {
	...
	function sendCommandWS(command, url, comType) {
	    ...
	    return function (dispatch) {
	        ...
	        return websocket_1.default.getInstance().send(jsonCommand, url).then(v => analyzeMessage(v, command.Ref));
	    };
	}
	...
	function getModelsWS(mes, url) {
	    return function (dispatch) {
	        ...
	        return websocket_1.default.getInstance().send(mes, url).then(v => analyzeMessage(v));
	    };
	}
